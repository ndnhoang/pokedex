var FormValidation = function() {
	...
	// add pokemon form
	var FormAddPokemonForm = function() {
		var form = $('#add_pokemon_form_form');
		var error = $('.alert-danger', form);
		var error_server = $('.alert-server', form);
		...
		form.validate({
			...
			errorPlacement: function(error, element) { // render error placement for each input type
				...
				if (element.attr('id') == 'original_pokemon') {
					var e_select = $('#original_pokemon-error').next();
					$('#original_pokemon-error').remove();
					error.insertAfter(e_select);
				}
			},
	...
	// edit pokemon form
	var FormEditPokemonForm = function() {
		var form = $('#edit_pokemon_form_form');
		var error = $('.alert-danger', form);
		var error_server = $('.alert-server', form);
	...
	// add pokemon statistic
	var FormPokemonStatistic = function() {
		var form = $('#statistic_pokemon_form');
		var error = $('.alert-danger', form);
		var error_server = $('.alert-server', form);
    ...
    // add species
	var FormAddSpecies = function() {
		var form = $('#add_species_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
    ...
    // edit species
	var FormEditSpecies = function() {
		var form = $('#edit_species_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
    ...
    // add egg group
	var FormAddEggGroup = function() {
		var form = $('#add_egg_group_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
    ...
    // edit species
	var FormEditEggGroup = function() {
		var form = $('#edit_egg_group_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
    ...
    // edit color
	var FormEditColor = function() {
		var form = $('#edit_color_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
    ...
    // add ability
	var FormAddAbility = function() {
		var form = $('#add_ability_form');
		var error = $('.alert-danger', form);
		var error_text = error.html();
