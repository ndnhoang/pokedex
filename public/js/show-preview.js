var ShowPreview = function() {
    ...
    // show avatar add pokemon form
    var AddPokemonFormPreview = function() {
        ...
        $('#add_pokemon_form_form').on('change', input, function() {
            var filename = input.val().replace(/\\/g, '/').replace(/.*\//, '');
                input.trigger('fileselect', [filename]);
        });
    ...
    // show avatar edit pokemon form
    var EditPokemonFormPreview = function() {
        ...
        $('#edit_pokemon_form_form').on('change', input, function() {
            var filename = input.val().replace(/\\/g, '/').replace(/.*\//, '');
                input.trigger('fileselect', [filename]);
        });
    ...
    return {
        init: function() {
            AddPokemonPreview();
            EditPokemonPreview();
            AddPokemonFormPreview();
            EditPokemonFormPreview();
        }
    };
}();
